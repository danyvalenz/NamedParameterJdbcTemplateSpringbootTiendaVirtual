package com.coppel.wsobtenerdatosclientetiendavirtual.execeptions;
...
public class AppExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleResponseStatusException(ResponseStatusException ex) {
        ...
        meta.setStatusCode(ex.getStatus().value());
        ...
        return new ResponseEntity<>(apiResponse, httpHeaders, ex.getStatus());
    }
